...
export default function CartButton({ count = 0, className = "" }: Props) {
  return (
    <Link
      href="/cart"
      className={`relative inline-flex items-center gap-2 rounded-full border border-gray-200 p-2.5 text-sm font-medium text-gray-700 hover:border-brand-primary hover:text-brand-dark transition-colors ${className}`}
    >
